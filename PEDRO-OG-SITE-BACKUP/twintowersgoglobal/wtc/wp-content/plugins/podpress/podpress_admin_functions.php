...
*/
	...
	function podPress_showID3tags($mediafile) {
		...
		$result .= '		<th>'.__('Artist', 'podpress').'</th><td><span id="podPressMedia_'.$randID.'_tagArtist">'.(!empty($fileinfo['comments']['artist'][0]) ? $fileinfo['comments']['artist'][0] : '&nbsp;').'</span></td>'."\n";
		$result .= '	</tr>'."\n";
		$result .= '	<tr>'."\n";
		$result .= '		<th>'.__('Album', 'podpress').'</th><td><span id="podPressMedia_'.$randID.'_tagAlbum">'.(!empty($fileinfo['comments']['album'][0]) ? $fileinfo['comments']['album'][0] : '&nbsp;').'</span></td>'."\n";
		$result .= '	</tr>'."\n";
		$result .= '	<tr class="alternate">'."\n";
		$result .= '		<th>'.__('Title', 'podpress').'</th><td><span id="podPressMedia_'.$randID.'_tagTitle">'.(!empty($fileinfo['comments']['title'][0]) ? $fileinfo['comments']['title'][0] : '&nbsp;').'</span></td>'."\n";
		$result .= '	</tr>'."\n";
		$result .= '	<tr>'."\n";
		$result .= '		<th>'.__('Description', 'podpress').'</th><td><span id="podPressMedia_'.$randID.'_tagDescription">'.(!empty($fileinfo['comments']['comment'][0])  ? $fileinfo['comments']['comment'][0] : '&nbsp;').'</span></td>'."\n";
		$result .= '	</tr>'."\n";
		$result .= '	<tr class="alternate">'."\n";
		$result .= '		<th>'.__('Genre', 'podpress').'</th><td><span id="podPressMedia_'.$randID.'_tagGenre">'.(!empty($fileinfo['comments']['genre'][0]) ? $fileinfo['comments']['genre'][0] : '&nbsp;').'</span></td>'."\n";
		$result .= '	</tr>'."\n";
		$result .= '	<tr>'."\n";
